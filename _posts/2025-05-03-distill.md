...
<d-figure>
  <img src="/assets/img/2025-05-03-distill-1.png" alt="Prompt Composition">
  <figcaption>Prompt Composition</figcaption>
</d-figure>
<p>
...
- **API Prompt 결과**
    - GPT < GPT-prompted < SFT < PPO < PPO-ptx 순으로 선호도가 증가하는 경향을 보임.<p>![선호도 증가](/assets/img/2025-05-03-distill-2.png)<p>
    - 세부 기준에 따라 선호도를 평가한 결과.<p><p>![선호도 증가](/assets/img/2025-05-03-distill-3.png)<p><p>

- **InstructGPT의 일반화 성능**
    - Reward model의 학습 과정 참여 여부를 기준으로 worker들을 구분하여, InstructGPT가 reward model에 과도하게 optimize 되었는지를 분석하고, 훈련 과정에 사용된 InstructGPT prompt와 그렇지 않은 GPT-3 prompt를 사용하여 선호로들 평가함으로써 InstructGPT의 일반화 성능을 평가.<p>![선호도 증가](/assets/img/2025-05-03-distill-4.png)<p><p>

- **공개된 NLP dataset-based FT 모델과 비교**
    - FLAN과 T0 dataset으로 FT 모델과 비교한 결과, SFT 모델보다는 좋지 못함 ⇒ 이 데이터셋은 선호도 반영을 위해서 언어 모델이 사용하는 방식을 반영하지 않음을 보임.<p>![선호도 증가](/assets/img/2025-05-03-distill-5.png)<p><p>

2. **공개 NLP Benchmark에 대한 결과**
- **Truthfulness (Honesty)**
![선호도 증가](/assets/img/2025-05-03-distill-6.png)
    - TruthfulQA dataset 평가 결과로, 각각 1.3/6/175B 모델
    - 회색은 informative
    - human evaluation을 진행한 것<p><p>

- **Toxicity**
![선호도 증가](/assets/img/2025-05-03-distill-7.png)
